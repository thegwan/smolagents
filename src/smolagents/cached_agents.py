...
"""
Refactor of original smolagents/agents.py to add a small model and large model
to support plan caching.
"""
import copy
import importlib
import json
...
from typing import TYPE_CHECKING, Any, Literal, Optional, Type, TypeAlias, TypedDict, Union
...
class MultiStepAgent(ABC):
    ...
    def _setup_step_callbacks(self, step_callbacks):
        ...
        # $$$$$$$$$$$ Don't register monitor updates because we explicitly update with more fine grain
        ...
        # self.step_callbacks.register(PlanningStep, self.monitor.update_metrics)
